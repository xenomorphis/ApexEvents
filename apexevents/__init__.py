        ...
        if self.tournament == 'level9':
            ...
            if self.current_map < 1:
                ...
                for i in range(len(self.tournament_pos), 0, -1):
                    ...
                    self.tournament_summit[i] = '{}%-%{}%-%{}'.format(player, self.tournament_player_names[player], 'FINAL')
                    ...
                    if self.current_map == 6:
                        ...
                        if self.current_run > 3 and rank > 4:
                            ...
                            if self.tournament_players[dnq_player] == self.tournament_players[self.tournament_pos[rank - 1]]:
                                ...
                                self.tournament_summit[rank] = '{}%-%{}%-%{}'.format(dnq_player, self.tournament_player_names[dnq_player], 'SEMI-FINAL')
                                del self.tournament_players[dnq_player]
                                rank -= 1
